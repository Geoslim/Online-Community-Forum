    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="{{ route('channels.index') }}"><i class="ti-rss"></i> <span>Channels</span></a></li>
                            <li><a href="{{ route('discussions.index') }}"><i class="ti-comments"></i> <span>Discussions</span></a></li>
                            {{-- <li>
                        ...
                        <ul class="notification-area pull-right">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu notify-box nt-enveloper-box">
                                    <span class="notify-title">You have 1 new notification(s) <a href="#">view all</a></span>
                                    <div class="nofity-list">
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2018. All right reserved. <a href="">Forum</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
