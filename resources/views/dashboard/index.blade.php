                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                <td class="mv-icon"><img src="dashboard-assets/images/icon/market-value/icon1.png" alt="icon">
                                                </td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="dashboard-assets/images/icon/market-value/icon2.png" alt="icon"></div>
                                                </td>
                                                <td class="coin-name">LiteCoin</td>
                                                <td class="buy">30% <img src="dashboard-assets/images/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="dashboard-assets/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                                <td class="trends"><img src="dashboard-assets/images/icon/market-value/trends-down-icon.png" alt="icon"></td>
                                                <td class="attachments">$ 56746,857</td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="dashboard-assets/images/icon/market-value/icon3.png" alt="icon"></div>
                                                </td>
